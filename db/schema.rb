...
ActiveRecord::Schema.define(version: 20140513131019) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "refinery_artist_translations", force: true do |t|
    t.integer  "refinery_artist_id"
    t.string   "locale"
    t.text     "bio"
  ...
  add_index "refinery_artist_translations", ["locale"], name: "index_refinery_artist_translations_on_locale", using: :btree
  add_index "refinery_artist_translations", ["refinery_artist_id"], name: "index_refinery_artist_translations_on_refinery_artist_id", using: :btree
  ...
  add_index "refinery_news_item_translations", ["refinery_news_item_id"], name: "index_refinery_news_item_translations_on_refinery_news_item_id", using: :btree
